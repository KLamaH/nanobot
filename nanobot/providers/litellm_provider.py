...
class LiteLLMProvider(LLMProvider):
    ...
    def _apply_cache_control(
        ...
        This maximises cache hits across multi-turn conversations (e.g. Anthropic,
        OpenRouter/Grok models with cache read discount).
        """
        ...
        def _mark(msg: dict[str, Any]) -> dict[str, Any]:
            ...
            if content is None or content == "":
                return {**msg, "content": [
                    {"type": "text", "text": "", "cache_control": cache_marker}
                ]}
